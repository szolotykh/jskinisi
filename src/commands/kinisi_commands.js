...
class Commands {
    ...
    async initialize_mecanum_platform(is_reversed_0, is_reversed_1, is_reversed_2, is_reversed_3, length, width, wheels_diameter, encoder_resolution){
        const messageLength = 37;
        const buffer = new ArrayBuffer(messageLength + 1);
        const view = new DataView(buffer);
        view.setUint8(0, messageLength);  // Message length
        ...
        view.setFloat64(30, encoder_resolution, true);  // encoder_resolution
        await this.write(buffer);
    }

    async initialize_omni_platform(is_reversed_0, is_reversed_1, is_reversed_2, wheels_diameter, robot_radius, encoder_resolution){
        const messageLength = 28;
        const buffer = new ArrayBuffer(messageLength + 1);
        const view = new DataView(buffer);
        view.setUint8(0, messageLength);  // Message length
        ...
        view.setFloat64(21, encoder_resolution, true);  // encoder_resolution
        await this.write(buffer);
    }
    ...
    async set_platform_controller(kp, ki, kd, integral_limit){
